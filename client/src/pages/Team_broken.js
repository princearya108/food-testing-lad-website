...
const Team = () => {
  ...
  // Force initial data to prevent blank page
  useEffect(() => {
    // Set fallback data immediately to prevent blank page
    const emergencyFallback = () => {
      console.log('Setting emergency fallback data...');
      setBoardMembers([
        {
          _id: 'emergency1',
      ...
      try {
        ...
        if (response.data.success) {
          ...
          setTimeout(() => {
            ...
            console.log('Final boardMembers state:', board);
          }, 100);
        } else {
        ...
        const fallbackBoardMembers = [
          {
            ...
            education: 'Ph.D. in Food Science, M.Tech Food Technology',
            specialization: 'Food Safety, Quality Assurance, Laboratory Management',
            achievements: ['ISO 17025 Lead Auditor', 'FSSAI Panel Expert', 'Published 25+ research papers'],
            isActive: true
          },
          {
            _id: 'board2',
            ...
            education: 'M.Sc. Chemistry, MBA',
            specialization: 'Laboratory Operations, Quality Management',
            achievements: ['NABL Technical Assessor', 'Six Sigma Black Belt'],
            isActive: true
          },
          {
            _id: 'board3',
            ...
            achievements: ['Chartered Accountant', 'Cost Accountant'],
            isActive: true
          }
        ];
        ...
        const fallbackTechnicalMembers = [
          {
            ...
            education: 'Ph.D. Analytical Chemistry',
            specialization: 'Chromatography, Spectroscopy, Chemical Analysis',
            achievements: ['Published 15+ papers', 'Method validation expert'],
            isActive: true
          },
          {
            _id: 'tech2',
            ...
            achievements: ['ISO 17025 Internal Auditor'],
            isActive: true
          },
          {
            _id: 'tech3',
            ...
            specialization: 'Nutritional Analysis, Method Development',
            achievements: ['Published 8+ papers'],
            isActive: true
          },
          {
            _id: 'tech4',
            ...
            specialization: 'Quality Control, Chemical Testing',
            achievements: ['NABL Training Certificate'],
            isActive: true
          }
        ];
        ...
        console.log('Fallback data set - Board:', fallbackBoardMembers.length, 'Technical:', fallbackTechnicalMembers.length);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      {/* Team Members */}
      <section ref={teamRef} className="py-20 bg-white" key={`team-${teamMembers.length}-${loading}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
