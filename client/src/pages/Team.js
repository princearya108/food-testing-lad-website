      ...
      <section ref={teamRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <FaFlask className="h-16 w-16 text-red-300 mx-auto mb-4" />
              <p className="text-xl text-red-500 mb-2">Error Loading Team Data</p>
            ...
            <div className="text-center py-12">
              ...
              <div className="mt-4 text-sm text-gray-500">
                <p>Departments: Chemical, Biological, Research</p>
                <p>Active team members will appear here</p>
              </div>
            </div>
          ) : (
            <>
